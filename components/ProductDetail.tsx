        ...
        <aside className="space-y-6 rounded-[36px] border border-slate-200 bg-white p-8 shadow-soft">
          <div className="space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {product.images.slice(1, 5).map((image) => (
                <div
                  key={image}
                  className="overflow-hidden rounded-[28px] border border-slate-200 bg-slate-100"
                >
                  <Image
                    src={image}
                    alt={product.title}
          ...
          >
            ...
            <ul className="mt-4 space-y-3 text-slate-600">
              <li className="before:mr-2 before:inline-block before:text-primary before:content-['•']">
                Motion-led product browsing
              </li>
              <li className="before:mr-2 before:inline-block before:text-primary before:content-['•']">
                Built with Next.js App Router
              </li>
              <li className="before:mr-2 before:inline-block before:text-primary before:content-['•']">
                Client cart state using Zustand
              </li>
            </ul>
          </motion.div>
        </aside>
